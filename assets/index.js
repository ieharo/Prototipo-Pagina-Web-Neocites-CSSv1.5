...
for(const men of menu){
    ...
    else if(men=='Carrito Compras'){
        ul.innerHTML+=`<li><a href="carrito.html" class="menu">${men}</a></li>`;
    }
...
for(const meniu of menu){
    ...
    else if(meniu=='Carrito Compras'){
        ulr.innerHTML+=`<li><a href="carrito.html" class="menu">${meniu}</a></li>`;
    }
